...
export default function HomeProduct() {
    ...
    async function getProduct() {
        const response = await axios.get(`http://localhost:8080/api/shops/${idShop}`);
    ...
    async function CreateOrder() {
        try {
            const orderResponse = await axios.post(`http://localhost:8080/api/order/${idUser}/${idShop}`);
    ...
    async function getMenu() {
        const response = await axios.get(`http://localhost:8080/api/menus/${idShop}`);
        console.log(response.data);
    ...
    const Showcar = async () => {
        try {
            const response = await axios.get(`http://localhost:8080/api/detailCart/${idShop}/${idUser}`);
    ...
    const addProductToCart = async (idShop, idUser, idProduct) => {
        try {
            const response = await axios.post(`http://localhost:8080/api/detailCart/${idUser}/${idShop}/${idProduct}`);
