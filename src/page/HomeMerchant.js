                ...
                <div className='listShop'>
                    {shop.map(item => (
                        <div className='carShop'>
                            ...
                            <span className='carShopNameText'>{item.idCity.name}</span>
                            <span className='carShopNameText'>{item.idCategory.name}</span>
                            <span className='carShopNameText'>{item.timeStart}</span>
                            <span className='carShopNameText'>{item.timeEnd}</span>
                        </div>
                    ))}
